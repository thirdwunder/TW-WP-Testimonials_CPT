...
class TW_Testimonials_Plugin_Settings {

	/**
	 * The single instance of TW_Testimonials_Plugin_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function add_menu_item () {
		$page = add_options_page( __( 'Plugin Settings', 'tw-testimonials-plugin' ) , __( 'TW Testimonials', 'tw-testimonials-plugin' ) , 'manage_options' , $this->parent->_token . '_settings' ,  array( $this, 'settings_page' ) );
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'tw-testimonials-plugin' ) . '</a>';
	...
	private function settings_fields () {
		...
		$settings['standard'] = array(
			'title'					=> __( 'Standard', 'tw-testimonials-plugin' ),
			'description'			=> __( 'Third Wunder Testimonials plugin general settings', 'tw-testimonials-plugin' ),
			'fields'				=> array(
  			array(
...
//		);
	...
	public function settings_page () {
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'Third Wunder Testimonials Plugin' , 'tw-testimonials-plugin' ) . '</h2>' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'tw-testimonials-plugin' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main TW_Testimonials_Plugin_Settings Instance
	 *
	 * Ensures only one instance of TW_Testimonials_Plugin_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see TW_Testimonials_Plugin()
	 * @return Main TW_Testimonials_Plugin_Settings instance
	 */
